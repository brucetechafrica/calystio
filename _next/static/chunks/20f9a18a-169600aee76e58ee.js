"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[567],{2550:function(e,t,i){i.d(t,{ab:function(){return e9},o:function(){return it}});var r,n=i(5816),s=i(4444),a=i(3333),o=i(7582),l=i(8463);function c(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let u=new s.LL("auth","Firebase",c()),h=new a.Yd("@firebase/auth");function d(e,...t){h.logLevel<=a.in.ERROR&&h.error(`Auth (${n.Jn}): ${e}`,...t)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function e4(e,t,i=!1){if((0,n.rh)(e.app))return Promise.reject(g(e));let r="signIn",s=await e1(e,r,t),a=await eQ._fromIdTokenResponse(e,r,s);return i||await e._updateCurrentUser(a.user),a}async function e5(e,t){return e4(ey(e),t)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function e6(e){let t=ey(e);t._getPasswordPolicyInternal()&&await t._updatePasswordPolicy()}function e9(e,t,i){return(0,n.rh)(e.app)?Promise.reject(g(e)):e5((0,s.m9)(e),eq.credential(t,i)).catch(async t=>{throw"auth/password-does-not-meet-requirements"===t.code&&e6(e),t})}new WeakMap;let e8="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
